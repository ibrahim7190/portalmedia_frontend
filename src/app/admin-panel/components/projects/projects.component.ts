...
export class ProjectsComponent implements OnInit {
  ...
  projects: any[] = [];
  fetchProjects() {
    this.http.get<any>('http://127.0.0.1:8000/api/projects')//http://127.0.0.1:8000/api/departments/1/getProjectsByDepartmentIdWithVideo
      .subscribe((response) => {
        this.projects = response.Data; // Assuming the response is an array of projects
